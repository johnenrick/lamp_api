...
class ClientAccountStatus extends Seeder
{
    ...
    public function run()
    {
      ...
      $statuses = [
        ...
        ["id" => 4, "description" => 'Re-call', "color" => "#ffc107", "has_calendar" => 1],
        ["id" => 5, "description" => 'Not Interested', "color" => "#6c757d", "has_calendar" => 0],
        ["id" => 6, "description" => 'Acceptance', "color" => "#28a745", "has_calendar" => 0],
        ["id" => 7, "description" => 'Follow Up', "color" => "#17a2b8", "has_calendar" => 1],
